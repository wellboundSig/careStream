...
const DRIFT_TABLES = [
  ...
  // ── IT Asset + Access Management (Support /user-solutions) ────────────────
  // DDL lives in db/migrations/0037_asset_management.sql (+ 0038 people seed).
  // Declared here so the registry (API whitelist) knows the tables/columns.
  {
    name: 'AssetMgtOrganizations',
    fields: [
      { name: 'id', type: 'singleLineText' },
      { name: 'name', type: 'singleLineText' },
  ...
  {
    name: 'AssetMgtSolutionCategories',
    fields: [
      { name: 'id', type: 'singleLineText' },
      { name: 'name', type: 'singleLineText' },
      { name: 'sort_order', type: 'number', options: { precision: 0 } },
  ...
  {
    name: 'AssetMgtSolutions',
    fields: [
      { name: 'id', type: 'singleLineText' },
      { name: 'name', type: 'singleLineText' },
      { name: 'category_id', type: 'multipleRecordLinks' },
      { name: 'solution_class', type: 'singleSelect' },
      { name: 'active', type: 'checkbox' },
      { name: 'requestable', type: 'checkbox' },
      { name: 'request_rank', type: 'number', options: { precision: 0 } },
  ...
  {
    name: 'AssetMgtSolutionOrganizations',
    fields: [
      { name: 'id', type: 'singleLineText' },
      { name: 'solution_id', type: 'multipleRecordLinks' },
      { name: 'organization_id', type: 'multipleRecordLinks' },
      { name: 'created_at', type: 'dateTime' },
      { name: 'updated_at', type: 'dateTime' },
    ],
  },
  {
    ...
    fields: [
      { name: 'id', type: 'singleLineText' },
      { name: 'employee_id', type: 'singleLineText' },
      { name: 'first_name', type: 'singleLineText' },
      { name: 'last_name', type: 'singleLineText' },
      { name: 'name', type: 'singleLineText' },
      { name: 'staff_type', type: 'singleSelect' },
      { name: 'discipline', type: 'singleLineText' },
  ...
  {
    name: 'AssetMgtUserSolutions',
    fields: [
      { name: 'id', type: 'singleLineText' },
      { name: 'user_id', type: 'multipleRecordLinks' },
      { name: 'solution_id', type: 'multipleRecordLinks' },
      { name: 'relationship_type', type: 'singleSelect' },
      { name: 'granted_date', type: 'date' },
      { name: 'revoked_date', type: 'date' },
      { name: 'granted_by_id', type: 'singleLineText' },
      { name: 'revoked_by_id', type: 'singleLineText' },
      { name: 'notes', type: 'multilineText' },
      { name: 'created_at', type: 'dateTime' },
      { name: 'updated_at', type: 'dateTime' },
    ],
  ...
  {
    name: 'AssetMgtHardwareTypes',
    fields: [
      { name: 'id', type: 'singleLineText' },
      { name: 'name', type: 'singleLineText' },
      { name: 'active', type: 'checkbox' },
      { name: 'supports_quantity', type: 'checkbox' },
      { name: 'allow_details', type: 'checkbox' },
      { name: 'sort_order', type: 'number', options: { precision: 0 } },
      { name: 'created_at', type: 'dateTime' },
      { name: 'updated_at', type: 'dateTime' },
    ],
  ...
  {
    name: 'AssetMgtUserHardware',
    fields: [
      { name: 'id', type: 'singleLineText' },
      { name: 'user_id', type: 'multipleRecordLinks' },
      { name: 'hardware_type_id', type: 'multipleRecordLinks' },
      ...
      { name: 'assigned_by_id', type: 'singleLineText' },
      { name: 'returned_by_id', type: 'singleLineText' },
      { name: 'notes', type: 'multilineText' },
      { name: 'created_at', type: 'dateTime' },
      { name: 'updated_at', type: 'dateTime' },
    ],
  ...
  {
    name: 'AssetMgtPresetItems',
    fields: [
      { name: 'id', type: 'singleLineText' },
      { name: 'preset_id', type: 'multipleRecordLinks' },
      { name: 'item_type', type: 'singleSelect' },
      { name: 'solution_id', type: 'multipleRecordLinks' },
      { name: 'relationship_type', type: 'singleSelect' },
      { name: 'hardware_type_id', type: 'multipleRecordLinks' },
      { name: 'quantity', type: 'number', options: { precision: 0 } },
  ...
  {
    name: 'AssetMgtOnboardingRequests',
    fields: [
      { name: 'id', type: 'singleLineText' },
      { name: 'token', type: 'singleLineText' },
      { name: 'new_hire_first_name', type: 'singleLineText' },
      { name: 'new_hire_last_name', type: 'singleLineText' },
      { name: 'new_hire_name', type: 'singleLineText' },
      { name: 'new_hire_title', type: 'singleLineText' },
      { name: 'staff_type', type: 'singleSelect' },
      { name: 'entity', type: 'singleLineText' },
      { name: 'start_date', type: 'date' },
      { name: 'hiring_manager_name', type: 'singleLineText' },
      { name: 'hiring_manager_email', type: 'email' },
      { name: 'status', type: 'singleSelect' },
      { name: 'asset_user_id', type: 'multipleRecordLinks' },
      { name: 'ticket_id', type: 'singleLineText' },
      { name: 'source_entry_id', type: 'singleLineText' },
      { name: 'submitted_at', type: 'dateTime' },
      { name: 'submitted_by_id', type: 'singleLineText' },
      { name: 'completed_at', type: 'dateTime' },
      { name: 'completed_by_id', type: 'singleLineText' },
      { name: 'notes', type: 'multilineText' },
      { name: 'created_at', type: 'dateTime' },
      { name: 'updated_at', type: 'dateTime' },
    ],
  ...
  {
    name: 'AssetMgtOnboardingRequestItems',
    fields: [
      { name: 'id', type: 'singleLineText' },
      { name: 'request_id', type: 'multipleRecordLinks' },
      { name: 'item_type', type: 'singleSelect' },
      { name: 'solution_id', type: 'multipleRecordLinks' },
      { name: 'relationship_type', type: 'singleSelect' },
      { name: 'hardware_type_id', type: 'multipleRecordLinks' },
      ...
      { name: 'fulfilled_by_id', type: 'singleLineText' },
      { name: 'created_at', type: 'dateTime' },
      { name: 'updated_at', type: 'dateTime' },
    ],
  },
...
const DRIFT_LINK_TARGETS = {
  ...
  'AssetMgtSolutions.category_id': 'AssetMgtSolutionCategories',
  'AssetMgtSolutionOrganizations.solution_id': 'AssetMgtSolutions',
  'AssetMgtSolutionOrganizations.organization_id': 'AssetMgtOrganizations',
  'AssetMgtUserSolutions.user_id': 'AssetMgtUsers',
  'AssetMgtUserSolutions.solution_id': 'AssetMgtSolutions',
  'AssetMgtUserHardware.user_id': 'AssetMgtUsers',
  'AssetMgtUserHardware.hardware_type_id': 'AssetMgtHardwareTypes',
  'AssetMgtPresetItems.preset_id': 'AssetMgtPresets',
  'AssetMgtPresetItems.solution_id': 'AssetMgtSolutions',
  'AssetMgtPresetItems.hardware_type_id': 'AssetMgtHardwareTypes',
  'AssetMgtOnboardingRequests.asset_user_id': 'AssetMgtUsers',
  'AssetMgtOnboardingRequestItems.request_id': 'AssetMgtOnboardingRequests',
  'AssetMgtOnboardingRequestItems.solution_id': 'AssetMgtSolutions',
  'AssetMgtOnboardingRequestItems.hardware_type_id': 'AssetMgtHardwareTypes',
};
