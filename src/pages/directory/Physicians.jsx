...
import AddPhysicianModal from '../../components/physicians/AddPhysicianModal.jsx';
...
export default function Physicians() {
  ...
  const filtered = useMemo(() => {
    const list = physicians.filter((p) => {
  ...
  if (!canViewDirectory(can, 'physicians')) {
    return <AccessDenied message="You do not have permission to view the Physicians directory." />;
  }
  const canCreate = canCreateDirectory(can, 'physicians');
  ...
  const colHdr = (label, field) => (
    <th
      ...
      style={{
        ...
        color: hexToRgba(palette.backgroundDark.hex, 0.4), whiteSpace: 'nowrap',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
          ...
          <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
            <div style={{
              ...
              padding: '0 12px', height: 34, width: 220,
            }}>
            ...
            {canCreate && (
              <button
                ...
                style={{
                  ...
                  fontSize: 13, fontWeight: 650, color: '#fff', cursor: 'pointer',
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 750 }}>
            ...
            <tbody>
              {!hydrated ? (
                ...
                <tr>
                  <td colSpan={6} style={{ padding: '40px 0', textAlign: 'center', fontSize: 13, color: hexToRgba(palette.backgroundDark.hex, 0.35), fontStyle: 'italic' }}>
                    No physicians found.
                  </td>
                </tr>
              ) : filtered.map((phy) => (
