...
export const PIN_GROUPS = [
  {
    ...
    items: [
      ...
      { label: 'Pipeline Overview', path: '/pipeline' },
      { label: 'Patients',   path: '/patients' },
      { label: 'Tasks',      path: '/tasks' },
      { label: 'Reports',    path: '/reports' },
      { label: 'HCHB Visit Check', path: '/tools/hchb-visit-check' },
    ],
  },
  {
    label: 'Directory',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Clinical Review',path: '/modules/clinical-rn' },
      ...
      { label: 'SOC/ROC',        path: '/modules/pre-soc' },
      { label: 'Completed',      path: '/modules/completed' },
