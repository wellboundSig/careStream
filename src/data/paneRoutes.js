...
export const PANE_NAV = [
  {
    ...
    items: [
      ...
      { path: '/pipeline', label: 'Pipeline Overview' },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/modules/clinical-rn', label: 'Clinical Review' },
      ...
      { path: '/modules/pre-soc', label: 'SOC/ROC' },
      { path: '/modules/completed', label: 'Completed' },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/tools/hchb-visit-check', label: 'HCHB Visit Check' },
    ],
  },
  {
    group: 'System',
